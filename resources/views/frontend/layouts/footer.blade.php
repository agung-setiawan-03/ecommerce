        ...
        <div class="row justify-content-between">
            ...
            <div class="col-xl-4 col-sm-7 col-md-8 col-lg-5">
                <div class="wsus__footer_content wsus__footer_content_2">
                    ...
                    <p>Dapatkan semua informasi terbaru tentang Acara, Penjualan, dan Penawaran.
                        Dapatkan semua informasi terbaru tentang Acara.</p>
                    ...
                    <div class="footer_payment">
                        <p>Kami menggunakan pembayaran yang aman untuk :</p>
