                ...
                <div class="col-xxl-9 col-xl-8 col-lg-8">
                    <div class="wsus__main_blog">
                        ...
                        <div class="wsus__comment_area">
                            ...
                            @endforeach
                            @if (count($comments) === 0)
                             <i>Jadilah orang pertama yang berkomentar! </i>
                            @endif
                        ...
                        <div class="wsus__post_comment">
                            ...
                            <form action="{{route('user.blog-comment')}}" method="POST">
                                ...
                                <button class="common_btn" type="submit">Kirim Komentar</button>
                            </form>
                            @else
                            <p>Silakan login untuk bisa mengomentari !</p>
                        ...
                        <div class="wsus__blog_post">
                            ...
                            <div class="wsus__blog_post_single">
                                ...
                                <div class="wsus__blog_post_text">
                                    ...
                                    <p> <span>{{date('M d Y', strtotime($blog->created_at))}} </span> {{count($blog->comments)}} Komen </p>
                                </div>
                            </div>
                            @endforeach
