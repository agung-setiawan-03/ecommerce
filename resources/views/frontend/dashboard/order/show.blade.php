            ...
            <div class="row">
                <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
                    <div class="dashboard_content mt-2 mt-md-0">
                        <h3><i class="far fa-user"></i> Detail Order</h3>
                                ...
                                <div class="">
                                    <div class="wsus__invoice_area">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-4 col-md-4">
                                                        <div class="wsus__invoice_single text-md-end">
                                                            ...
                                                            <p>Id Transaksi: {{ $order->transaction->transaction_id }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="wsus__invoice_footer">
                                            ...
                                            <p><span>Biaya pengiriman(+):</span>{{ @$settings->currency_icon }} {{@$shipping->cost}} </p>
                                            <p><span>Kupon(-):</span>{{ @$settings->currency_icon }} {{@$coupon->discount ? $coupon->discount : 0}}</p>
                                            <p><span>Jumlah total :</span>{{ @$settings->currency_icon }} {{@$order->amount}}</p>
